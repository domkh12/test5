...
function CardProject({img, title, desc,link}) {
  return (
    <Link to={link} className='relative w-[350px] h-[350px] rounded-lg overflow-hidden group'>
        <div className='w-[350px] h-[350px] bg-primary-developer-template bg-opacity-0 group-hover:bg-opacity-50 absolute z-10 flex flex-col justify-center items-center'>
