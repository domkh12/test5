...
export default function NavBarComponent() {
  ...
  return (
    <motion.nav
      ...
      className="menu flex flex-wrap items-center justify-between px-20 lg-max:px-10 py-4 fixed top-0 z-20 w-full drop-shadow-md font-sans dark:bg-gray-900 dark:text-gray-100 bg-white"
    >
      <Link
        activeClass="active"
        to="hero"
